...
<html lang="en">
  <head>
      ...
      <meta charset="utf-8">
        ...
        <link rel="stylesheet" href="ststyle.css"  type="text/css">
    ...
    <div class ="container"> 
       <div class="row">
         ...
         <form action="changestat.php" method="post">
             <div class="log_area">
             <h1 class="text-center"><u>Current Status</u></h1>
                  <hr>
            <table >  
             ...
             <tr>
                <?php 
               if($stat ==1) {
                ?> <h2 style ="color: blue"><b>You are now Avaiable in donor list(1)</b> </h2>
                ...
                ?> <h2 style ="color: blue"><b>You are not Avaiable in donor list(!1) </b> </h2> <?php
               }

               ?>
             <tr>
               <td><h5 style ="color: green"><b>UpdateStatus</b> </h5></td>
               <td>
                 <form  action="changestat.php" method="post">
             ...
             <p>
              <button type="submit" class="btn btn-outline-dark  " style="margin-left:200px;margin-top: 30px; padding: 6px 23px; font-size:18px;"><b>Update Status</b>
