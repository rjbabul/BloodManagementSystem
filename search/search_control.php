...
<html lang="en">
 ...
 if( $con->connect_error){
  die('Connection Failed'.$con->connect_error) ;
    ...
    $sql = "SELECT  r.user_name ,r.name , r.blood_group, p.org ,p.con , p.occ,p.image FROM register r, profile p where  r.user_name= p.username and blood_group='$bd'  and  stat='1'";
  ...
  <img  src="<?php echo  $row['image'];?>"   height="170" class="card-img-top">
  <div class="card-body">
...
<?php
    ...
    ?> <h1><b class="display 1"><?php echo "0 results";?></b></h1><?php
}
$con->close();
 }
